...
SENSORS = [
    ...
    ("I_max1", "I_max1", lambda d: _num(d, "I_max1", None), "A", "mdi:arrow-collapse-up", False, True),
    ("I_min_c1", "I_min_c1", lambda d: _num(d, "I_min_c1", None), "A", "mdi:arrow-collapse-down", False, True),
    ("I_charge_manual1", "I_charge_manual1", lambda d: _num(d, "I_charge_manual1", None), "A", "mdi:lightning-bolt", False, True),
